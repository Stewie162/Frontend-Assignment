document.addEventListener("DOMContentLoaded", function () {
  ...
  const coffees = [
    ...
    },
    {
      ...
      description: "Bold and fruity flavors with bright acidity and floral notes",
    ...
    },
    {
      ...
      description: "Rich and intense with a velvety crema and chocolate undertones",
    ...
    {
      name: "Decaf Blend",
      description: "Full-flavored without the caffeine, featuring notes of caramel and nuts",
    ...
    },
    {
      ...
      description: "Ethically sourced and delicious with a balanced flavor profile",
    ...
    },
    {
      ...
      description: "Bright and clean with notes of honey, citrus, and a crisp finish",
    ...
    {
      name: "Kenyan AA",
      description: "Bold and complex with wine-like acidity and blackcurrant notes",
    ...
    },
    {
      ...
      description: "Medium-bodied with spicy and smoky notes and a chocolate finish",
    ...
    },
    {
      ...
      description: "Smooth and mild with a clean taste and subtle floral sweetness",
    ...
    {
      name: "Hawaiian Kona",
      description: "Delicate and aromatic with notes of brown sugar and tropical fruits",
    ...
    coffeeList.forEach((coffee) => {
      ...
      coffeeCard.innerHTML = `
        ...
        <div class="product-footer">
          ...
          <button class="btn" data-name="${coffee.name}" data-price="${coffee.price}" data-image="${coffee.image}">
  ...
  function searchCoffees() {
    ...
    document.getElementById('clear-search').style.display = searchTerm.length > 0 ? 'block' : 'none';
    animateCards();
  }
